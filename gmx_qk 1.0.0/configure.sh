...
sudo cp logo.tiff /usr/share/icons/gmx_qk
sudo cp logo.tiff /usr/share/icons/gmx_trj_qk
sudo chmod +x /usr/share/icons/gmx_qk
sudo chmod +x /usr/share/icons/gmx_trj_qk
...
sudo cp gmx_trj_qk.desktop /usr/share/applications
sudo chmod +x /usr/share/applications/gmx_trj_qk.desktop
