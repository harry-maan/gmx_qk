...
Help()
{
  ans=$(zenity --info --title 'gmx_qk 1.0.0' \
      --text 'Welcome to the gmx_qk' \
      --ok-label Quit \
      --extra-button Tutorial \
      --extra-button Workflow \
      --extra-button License \
      --extra-button "Let's go!!" --width 300 --height 100 )
  rc=$?
#  echo "${rc}-${ans}"
  echo $ans
  if [[ $ans = "Tutorial" ]]
...
{	
	  zenity --text-info \
       --title="LICENSE" \
       --text="*****Topology and Simulation***** \n
       version 1.0.0 \n
       Written by Harvinder Singh, PhD Scholar \n
       Dept. of Pharmacology, PGIMER, Chandigarh (160012) \n
       s.harvinder.stu@pgimer.edu.in \n
       harvindermaan4@gmail.com \n
       All the rights are reserved with author. :)" \
...
echo "" 
	echo "PhD scholar, Dept. of Pharmacology, PGIMER, Chandigarh"
	echo "harvindermaan4@gmail.com"
	echo
}
